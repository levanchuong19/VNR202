...
export function Navbar() {
  ...
  const navItems = [
    ...
    { label: "Thời Gian", href: "#thoigian" },
    { label: "Điện Biên Phủ", href: "#dienbienphu" },
    { label: "Bài Học", href: "#baihoc" },
    { label: "Thư Viện", href: "#thuvien" },
    { label: "Giá Trị", href: "#giatri" },
  ];
        ...
        <div className="flex items-center justify-between">
          <motion.div
            className={`text-2xl font-bold cursor-pointer transition-colors duration-300 ${
              isScrolled ? "text-white" : "text-[var(--color-accent)]"
            }`}
          ...
          <div className="hidden md:flex space-x-8">
            {navItems.map((item, index) => (
              <motion.a
                ...
                className="text-(--color-text-muted) hover:text-white transition-colors cursor-pointer underline-animated relative hover-text-white"
